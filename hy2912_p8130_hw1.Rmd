...
Given the qualitative nature of vec_char and vec_fact, determining the mean is not avaialble (NA). These two vectors represent nominal and ordinal categorical variables, respectively. 
